...
class BaseConfigManager(override val project: Project) : ConfigManager {
  ...
  private fun addDependencies() {
    project.dependencies.add("implementation", "com.google.guava:guava:31.0.1-jre") // This is only required because the version pulled in as a transitive dependency has CVE vulnerabilities
  }
  ...
  private fun setJunit5() {
    ...
    project.configurations.findByName("testImplementation")?.dependencies?.find { it.group == "junit" }?.version
      ...
      .run { project.dependencies.add("testImplementation", "org.junit.vintage:junit-vintage-engine:5.8.2") }
  }
}
