...
class DependencyManagementPluginManagerReactorTest : GradleBuildTest() {
  ...
  private fun jarContainsNettyCommon(jar: JarFile, version: String): Boolean =
    jar.getJarEntry("BOOT-INF/lib/reactor-netty-http-$version.jar") != null
  ...
  fun `Wrong transitive version of netty should be overridden by the plugin`(projectDetails: ProjectDetails) {
    ...
    assertThat(jarContents)
      .doesNotContain("BOOT-INF/lib/reactor-netty-http-1.1.12.jar")
      .contains("BOOT-INF/lib/reactor-netty-http-1.1.13.jar")
  }
}
